...
describe('Prueba la navegación y routing del header y footer', ()=>{
    it('Prueba la navegación del header', ()=>{
        ...
        cy.get('[data-cy="navegacion-header"]').should('have.prop', 'class').should('equal', 'navegacion')
        cy.get('[data-cy="navegacion-header"]').should('have.prop', 'class').should('equal', 'navegacion')
    ...
    it('Prueba la navegación del footer', ()=>{
        ...
        cy.get('[data-cy="navegacion-footer"]').should('have.prop', 'class').should('equal', 'navegacion nav-footer')
